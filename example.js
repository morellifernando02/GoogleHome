...
exports.dialogflowFirebaseFulfillment = functions.https.onRequest((request, response) => {
  ...
  function fallback(agent) {
    ...
    agent.add('I didnt understand user id ' );
    agent.add('Im sorry, can you try again? user id ' );
...
//saveDataToDB(userId, data);
  ...
  intentMap.set('ObtenerRespuesta', welcome);
  intentMap.set('ObtenerRespuesta', fallback);
